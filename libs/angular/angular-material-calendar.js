angular.module("ngCalander", ["ngMaterial", "ngSanitize"]);

angular.module("ngCalander").constant("ngCalander.config", {
    version: "0.2.13",
    debug: document.domain.indexOf("localhost") > -1
});

angular.module("ngCalander").config(["ngCalander.config", "$logProvider", "$compileProvider", function (config, $logProvider, $compileProvider) {
    if (config.debug) {
...
angular.module("ngCalander").service("ngCalander.Calendar", [function () {
...
angular.module("ngCalander").service("MaterialCalendarData", [function () {
...
angular.module("ngCalander").directive("calendarMd", ["$compile", "$parse", "$http", "$q", "ngCalander.Calendar", "MaterialCalendarData", function ($compile, $parse, $http, $q, Calendar, CalendarData) {
